// Online_2.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_ONLINE2, szWindowClass, MAX_LOADSTRING);
    ...
    MSG msg;
    ZeroMemory(&msg, 0);
    GraphicManager::Init(hWnd);     //순서 잘 지켜서 코딩
    gs.Init();
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ONLINE2));
